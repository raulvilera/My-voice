    ...
    <div className={styles.loginPage}>
      <div className={styles.card}>
        <div className={styles.logoArea}>
          <img src="/my_voice_default_v4.png" alt="My Voice Logo" style={{ width: '130px', height: '130px', objectFit: 'cover', marginBottom: '0.5rem', borderRadius: '50%', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }} />
