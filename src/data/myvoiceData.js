        ...
        <div className={styles.secao}>
          ...
          {stream && !gravando && (
            <p className={styles.dica} style={{ marginTop: '0.75rem' }}>
              Câmera pronta! Clique em <strong>"Iniciar Gravação"</strong> para começar a gravar de fato.
            </p>
          )}

          {gravando && (
            <p className={styles.dica} style={{ marginTop: '0.75rem' }}>
              Gravando... os botões <strong>"Pausar"</strong> e <strong>"Parar e Revisar"</strong> também aparecem fixos no rodapé da tela, mesmo se você rolar para baixo.
            </p>
          )}
